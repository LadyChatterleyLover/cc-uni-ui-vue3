<template>
  <view>
    ...
    <view>
      ...
      <view class="item">
        <cc-modal v-model="show2" content="朋友我当你一秒朋友,朋友,我当你一世朋友"></cc-modal>
    ...
    <view>
      ...
      <view class="item">
        <cc-modal v-model="show3" showCancelButton title="最佳损友" content="严重似情侣讲分手"></cc-modal>
    ...
    <view>
      ...
      <view class="item">
        <cc-modal v-model="show4" title="最佳损友" closeOnClickOverlay content="我有痛快过你有没有"></cc-modal>
    ...
    <view>
      ...
      <view class="item">
        <cc-modal v-model="show7" showCancelButton title="东邪西毒">
          <template #content>
    ...
    <view>
      ...
      <view class="item">
        <cc-modal v-model="show8" asyncClose showCancelButton title="东邪西毒" content="看见他走的时候,我的内心在嫉妒">
          <template #button>
