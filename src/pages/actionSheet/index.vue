<template>
  <view>
    ...
    <view>
      ...
      <view class="item">
        <cc-action-sheet v-model="show4" showCancel description="这是一段描述信息">
          <cc-action-sheet-item name="选项一"></cc-action-sheet-item>
          <cc-action-sheet-item name="选项二"></cc-action-sheet-item>
          <cc-action-sheet-item name="选项三"></cc-action-sheet-item>
        </cc-action-sheet>
    ...
    <view>
      ...
      <view class="item">
        <cc-action-sheet v-model="show5" closeable showCancel description="这是一段描述信息">
          <cc-action-sheet-item name="选项一"></cc-action-sheet-item>
          <cc-action-sheet-item name="选项二"></cc-action-sheet-item>
          <cc-action-sheet-item name="选项三"></cc-action-sheet-item>
        </cc-action-sheet>
    ...
    <view>
      ...
      <view class="item">
        ...
        >
          ...
          <cc-action-sheet-item name="选项三" loading></cc-action-sheet-item>
        </cc-action-sheet>
    ...
    <view>
      ...
      <view class="item">
        <cc-action-sheet cancelText="关闭" v-model="show9" title="标题">
          <cc-action-sheet-item name="选项一"></cc-action-sheet-item>
          <cc-action-sheet-item name="选项二"></cc-action-sheet-item>
          <cc-action-sheet-item name="选项三"></cc-action-sheet-item>
        </cc-action-sheet>
